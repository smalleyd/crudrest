...
var ClientsHandler = new ListTemplate({
	...
	FIELDS: [ new TextField('id', 'ID'),
		...
		new EditField('resumeLocale', 'Resume Locale', true, false, 16, 10),
		new EditField('googleDocsMimeType', 'Google Docs MIME Type', true, false, 128, 50),
		new BoolField('answerPurgerEnabled', 'Answer Purger Enabled?', true),
		new BoolField('deleteQuestionsEnabled', 'Delete Questions Enabled?', true),
		new BoolField('getQuestionsEnabled', 'Get Questions Enabled?', true),
		...
		new BoolField('multilingualEnabled', 'Multilingual Enabled?', true),
	...
	SEARCH: {
		...
		FIELDS: [ new EditField('id', 'ID', false, false, 20, 10),
			...
			new EditField('resumeLocale', 'Resume Locale', false, false, 16, 10),
			new EditField('googleDocsMimeType', 'Google Docs MIME Type', 128, 50),
			new ListField('answerPurgerEnabled', 'Answer Purger Enabled?', false, 'yesNoOptions', undefined, 'No Search'),
			new ListField('deleteQuestionsEnabled', 'Delete Questions Enabled?', false, 'yesNoOptions', undefined, 'No Search'),
			new ListField('getQuestionsEnabled', 'Get Questions Enabled?', false, 'yesNoOptions', undefined, 'No Search'),
			...
			new ListField('multilingualEnabled', 'Multilingual Enabled?', false, 'yesNoOptions', undefined, 'No Search'),
			new EditField('careersEmailAddress', 'Careers Email Address', false, false, 255, 50),
			new DropField('defaultLanguageId', 'Select Default Language', true, 'languages', 'defaultLanguageName'),
			new TextField('defaultLanguageName', 'Selected Default Language', undefined, undefined, true),
